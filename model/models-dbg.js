...
function (JSONModel, Device) {
    ...
    return {
        ...
        createProjectsModel: function () {
            var aProjects = [
                { name : "Address Validation Extension for SSCv2", description: "Designed and developed a secure side-by-side extension on SAP BTP to automate and ensure the accuracy of customer address data within SAP Sales and Service Cloud Version 2 (SSCv2).\n\n The Workflow: When an Account is created or updated in SSCv2, a Webhook instantly triggers a background event, sending the address data to a custom SAP CAP (Node.js) backend service on BTP.\n The Integration: The CAP service communicates with an external verification API to validate the address details.\n The User Experience: The validated results, along with correction suggestions, are seamlessly rendered directly inside the SSCv2 Account screen via an embedded UI Mashup. \n\n This solution satisfies the core business requirement of eliminating manual data verification, drastically reducing shipping or billing errors, and maintaining a clean master data directory without forcing users to leave their native CRM screens." },
